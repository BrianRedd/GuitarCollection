...
export const getUser = createAsyncThunk("user/getUser", username => {
  return axios.get(`${baseURL}/getuser/${username}`).then(response => {
...
export const addUser = createAsyncThunk("user/saveUser", userObject => {
  return axios.post(`${baseURL}/saveuser`, userObject).then(response => {
...
export const updateUser = createAsyncThunk("user/updateUser", userObject => {
  ...
  return axios
    .put(`${baseURL}/updateuser/${userObject._id}`, userObject)
    .then(response => {
      enqueueSnackbar(response.data.message);
      return response.data;
    });
...
export const deleteUser = createAsyncThunk("user/deleteUser", userObject => {
  return axios
    .delete(`${baseURL}/deleteuser/${userObject._id}`, {
      data: userObject
    })
    .then(response => {
      enqueueSnackbar(response.data.message);
